...
export default function FormWrapper({formTitle, defaultValues, wrappedOnSubmit}: Props) {
    ...
    return (
        <div className={` flex justify-center items-center min-h-screen  bg-gradient-to-tr from-gray-300 to-cgray-dark dark:from-gray-700 dark:to-gray-700`}>
            ...
            <Form title={formTitle} defaultValues={defaultValues} onSubmit={onSubmit} customFormState={customFormState} useFormReturn={useFormReturn} />            
        </div>
        </div>
