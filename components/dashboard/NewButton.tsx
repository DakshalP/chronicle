...
const NewButton = () => (
    <Link href={path} className="active:scale-95 transition-transform lg:mt-16 lg:mb-0 my-5 text-white px-8 sm:py-5 py-4 w-fit bg-gradient-to-tr from-cgreen-dark via-cgreen to-cgreen-light dark:via-cgreen dark:to-cgreen rounded-lg flex flex-row items-center gap-2">
