...
const NewButton = () => (
    <Link href={path} className="active:scale-95 transition-transform lg:mt-16 lg:mb-0 my-5 text-white px-8 py-5  w-fit bg-gradient-to-tr from-cgreen to-green-500 rounded-lg flex flex-row items-center gap-2">
