...
const inputVariants = cva(
    `transition-all font-medium bg-white border-4 border-cgray text-gray-900 rounded outline-none
     focus:ring-cgreen focus:border-cgreen block w-full 
     dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-cgray-outline dark:focus:border-gray-400`,
    {
        variants: {
            variant: {
